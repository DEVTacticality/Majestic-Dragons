package net.smazeee.majesticdragons.screen;
...
public class UtilityMenu extends AbstractContainerMenu {
    private final Level level;
    private final ContainerData data;

    public UtilityMenu(int containerID, Inventory inv, FriendlyByteBuf extraData) {
        this(containerID, inv, new SimpleContainerData(5));
    }

    public UtilityMenu(int containerId, Inventory inv, ContainerData data) {
        super(ModMenuTypes.UTILITY_MENU.get(), containerId);
